...
// 워크그룹(256스레드) = 출력 vec4 셀 하나. 스레드가 kg를 256-stride로 나눠 부분합,
// 공유메모리 트리 리덕션. 기존 small 변형의 "36스레드 × K직렬" 기아를 해소한다.
// 슬롯: TYPES, RES_BINDING, OUT_BINDING, CONSTS, EPILOGUE
